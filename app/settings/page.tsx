...
const INSTRUCTIONS = [
  ...
  { title: "🌀 Pensieve", description: "Three-stage AI search. Stage 1 (Cerebras): instant keyword scan. Stage 2 (DeepSeek): investigates candidates for true relevance. Stage 3 (Gemini): writes a narrative answer. Filter by category, search by keyword, edit or delete entries inline." },
  ...
  { title: "✨ The Archivist", description: "Three specialized AI models working as one. Gemini (The Archivist) handles quality tasks — Master Prompt refine, Prompt Forge, Chat, Pensieve answers. DeepSeek (The Historian) handles truth tasks — Extract to Vault, Inbox sorting, Verify Categories, Targeted Delete. Cerebras (The Clerk) handles speed tasks — Pensieve keyword search, fast retrieval." },
];
